...
const app=exp();
//to access data from excel and  acts as middleware
...
const url="mongodb://scls:scls@cluster0-shard-00-00-s0alc.mongodb.net:27017,cluster0-shard-00-01-s0alc.mongodb.net:27017,cluster0-shard-00-02-s0alc.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority";
var dbo;
...
const transport = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
        user: 'vijayalakshmi.ndg@gmail.com',
        pass: 'Forresume',
    },
});
const mailOptions = {
    from: 'vijayalakshmi.ndg@gmail.com',
